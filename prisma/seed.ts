...
//   const users = [
//     { email: 'admin@securestore.com', firstName: 'Admin', lastName: 'User', password: passwordHash, roleName: 'GLOBAL_ADMIN' },
//     { email: 'tenant@securestore.com', firstName: 'Tenant', lastName: 'Admin', password: passwordHash, roleName: 'TENANT_ADMIN' },
//     { email: 'manager@securestore.com', firstName: 'Funtua', lastName: 'Manager', password: passwordHash, roleName: 'WAREHOUSE_MANAGER' },
//     { email: 'manager2@securestore.com', firstName: 'Lagos', lastName: 'Manager', password: passwordHash, roleName: 'WAREHOUSE_MANAGER' },
//     { email: 'firstbank@securestore.com', firstName: 'First', lastName: 'Bank', password: passwordHash, roleName: 'FINANCIER' },
//     { email: 'demo@securestore.com', firstName: 'John', lastName: 'Doe', password: passwordHash, roleName: 'CLIENT' },
//   ];
...
//     { name: 'Tanks', unitOfMeasure: MeasurementUnit.LITRE, description: 'Standard' },
//     { name: 'Doors', unitOfMeasure: MeasurementUnit.KILOGRAM, description: 'Grade A' },
//     { name: 'Wheat', unitOfMeasure: MeasurementUnit.METRIC_TON, description: 'Grade A, B' },
//     { name: 'Palm Oil', unitOfMeasure: MeasurementUnit.LITRE, description: 'Grade A' },
//   ];
...
//         where: { warehouseId_commodityId: { warehouseId: w.id, commodityId: c.id } },
//         update: {},
//         create: {
//           warehouseId: w.id,
//           commodityId: c.id,
...
//     { num: 'WR-2025-0012', comm: 'Tanks', qty: 500, grade: 'Standard', wh: 'Lagos State Warehouse', status: ReceiptStatus.CANCELLED }, // TRADED doesn't exist in enum
...
//             quantity: r.qty,
//             quantityAvailable: ([ReceiptStatus.PLEDGED, ReceiptStatus.LIEN] as ReceiptStatus[]).includes(r.status) ? 0 : r.qty,
//             grade: r.grade,
//             status: r.status,
