// ISO 3166-1 alpha-2 country list with name and international dial code.
// Source: ITU-T E.164 + ISO 3166. Static — does not change at runtime.
// Kept here (not JSON) so the type and tree-shaking work cleanly.

export interface Country {
  code: string; // ISO 3166-1 alpha-2
  name: string;
  dialCode: string; // E.164 country calling code, without leading '+'
}
